%%Figure 13. Time series diagram of different publicity strategies.%%
clear 
clc
...
figure(3)
      ...
      h3=legend('k=0.001,$\tau$=27','k=0.008,$\tau$=7');%%(a)
      %h3=legend('k=0.02,$\tau$=4','k=0.003,$\tau$=13');%%(b)
      %h3=legend('k=0.25,$\tau$=1.09','k=0.3,$\tau$=0.99','k=0.35,$\tau$=0.92','k=0.4,$\tau$=0.85','k=0.45,$\tau$=0.8','k=0.5,$\tau$=0.75');%%(c)
