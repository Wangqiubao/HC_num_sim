%%%%Figure4. The time series diagram of S,E,A,V,Q,R with the parameter tau=15 >tau_0%%%
clear 
clc
...
figure(2)
      ...
      set(gca,'FontSize',17,'Fontname','Time New Roman');
      shading interp;
      axis([2000,inf,0.008748,0.00875])
...
figure(3)
      ...
      set(gca,'FontSize',17,'Fontname','Time New Roman');
      shading interp;
       axis([1000,inf,0.007166,0.007168])
...
figure(5)
   ...
   plot(TimeGrid,mean(Rsolution)/N,'b-','LineWidth',1)
      ...
      set(gca,'FontSize',17,'Fontname','Time New Roman');
      shading interp;
      axis([2000,inf,0.385605,0.38561])
