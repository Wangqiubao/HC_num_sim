...
Solution(:,k) =552030.54*rand(1);%1244276
Esolution(:,k) =1405470.79*rand(1);%47301
Asolution(:,k) =87494.34*rand(1);%2945
Qsolution(:,k)=71666.046*rand(1);%2412
Vsolution(:,k) =4741153.57*rand(1);%9287559
Rsolution(:,k) =3142180*rand(1);%129778
end
...
h1=xlabel('$t$','FontSize',15);
      h2=ylabel('$Q\ Variance$','FontSize',15);
      set(h1,'Interpreter','latex');
      set(h2,'Interpreter','latex');
      set(gca,'FontSize',17,'Fontname','Time New Roman');
      shading interp;
     h3= legend('K=1','K=10','K=15','K=20');
     set(h3,'FontName','Times New Roman','FontSize',11,'box','off');