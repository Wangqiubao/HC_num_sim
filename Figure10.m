%%Figure 10. Time series diagram with noise intensity K as bifurcation parameter when tau =12.562. (a) K=1, (b) K=200.%%%
clear 
clc
...
figure(3)
      ...
      shading interp;
      axis([4000,inf,0.00716659,0.00716665])